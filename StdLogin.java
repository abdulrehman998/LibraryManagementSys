...
public interface StdLogin extends StdView{
	public default void StudentLogin() {
		...
		Text txt3 = new Text("STUDENT LOGIN");
		...
		bt4.setOnAction(new EventHandler<ActionEvent>() {
			 @Override
			    public void handle(ActionEvent e){
				 if (tf1.getText().equals("std") && (tf2.getText().equals("s123"))) {
		 ...
		 Button bt15 = new Button();
	      bt15.setText("Go Back");
	      bt15.setFont(Font.font(14));
			bt15.setPrefWidth(80);
	      root.add(bt15, 11, 11);
